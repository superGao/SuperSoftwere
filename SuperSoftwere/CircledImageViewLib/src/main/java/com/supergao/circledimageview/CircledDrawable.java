...
public class CircledDrawable extends Drawable {
  ...
  public static CircledDrawable fromBitmap(Bitmap bitmap) {
    if (bitmap != null) {
  ...
  public CircledDrawable setCornerRadius(float radius) {
  ...
  public CircledDrawable setBorderWidth(float width) {
    mBorderWidth = width;
    mBorderPaint.setStrokeWidth(mBorderWidth);
    return this;
  }
  ...
  public CircledDrawable setBorderColor(int color) {
  ...
  public CircledDrawable setBorderColor(ColorStateList colors) {
  ...
  public CircledDrawable setOval(boolean oval) {
    mOval = oval;
    return this;
  }
  ...
  public CircledDrawable setScaleType(ScaleType scaleType) {
    if (scaleType == null) {
  ...
  public CircledDrawable setTileModeX(Shader.TileMode tileModeX) {
  ...
  public CircledDrawable setTileModeY(Shader.TileMode tileModeY) {

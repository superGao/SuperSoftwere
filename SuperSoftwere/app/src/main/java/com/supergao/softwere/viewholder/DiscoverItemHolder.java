...
/**
 *附近fragment viewHolder
 *@author superGao
 *creat at 2016/4/14
 */
public class DiscoverItemHolder extends CommonViewHolder<UserInfo> {
  ...
  public void bindData(UserInfo user) {
    ...
    if (null != user) {
      ...
      AVGeoPoint geoPoint = user.getAVGeoPoint(UserInfo.LOCATION);
      ...
      if (geoPoint != null && !currentLat.equals("") && !currentLong.equals("")) {
        ...
        user.getAVGeoPoint(UserInfo.LOCATION).getLatitude(),
        user.getAVGeoPoint(UserInfo.LOCATION).getLongitude());

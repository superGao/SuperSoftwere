...
import com.supergao.softwere.utils.SimpleNetTask;
...
class AddRequestManager {
  ...
  public void countUnreadRequests(final CountCallback countCallback) {
    ...
    addRequestAVQuery.whereEqualTo(AddRequest.TO_USER, UserInfo.getCurrentUser());
  ...
  private void createAddRequest(UserInfo toUser) throws Exception {
  ...
  public void createAddRequestInBackground(Context ctx, final UserInfo user) {

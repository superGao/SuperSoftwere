...
import com.supergao.software.activity.AboutUsActivity;
import com.supergao.software.activity.SetMessageActivity;
        ...
        getApp().getAppAction().getVersionCode(version,
                new DefaultActionCallbackListener<VersionInfo>(getActivity()) {
                    ...
                    public void onSuccess(VersionInfo data) {
                        ...
                        if (null != data) {
                            version_net = data.getVersion();
                            url_net = data.getUrl();
                            versionName = data.getName();
                            showDialog();
                        } else {
